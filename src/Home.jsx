          ...
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 reveal-left">
              ...
              <div className="space-y-8 text-gray-400 text-lg leading-relaxed">
                <p>
                  <b className='text-cyan-400 font-extrabold text-xl tracking-wider animate-pulse'>YASDA SYSTEM</b> is an elite engineering collective forged in 2021. We eliminate the noise of modern software delivery, focusing on pure, high-performance digital infrastructure.
                </p>
                <p>
